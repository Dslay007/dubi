...
<x-master-header 
    title="Daftar Peladen (Server)" 
    subtitle="Kelola pengaturan server Z39.50 atau P2P untuk salin katalog." 
    icon="server"
    createRoute="admin.server.create"
    createLabel="Tambah Server"
/>
