...
@section('pageTitle', 'Import Bahasa (CSV)')

@section('content')
<div style="background: white; border-radius: 0.5rem; border: 1px solid #e2e8f0; padding: 2rem; max-width: 800px;">
    <h3 style="font-weight: 700; color: #1e293b; margin-bottom: 1rem;">Impor Data Bahasa dari CSV</h3>
    ...
    <div style="background: #f1f5f9; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem; font-size: 0.9rem; color: #475569;">
        ...
        <ul style="margin-left: 1.5rem; margin-top: 0.5rem;">
            <li>Kolom 1: <strong>ID Bahasa</strong> (Wajib, maks 5 karakter)</li>
            <li>Kolom 2: <strong>Nama Bahasa</strong> (Wajib)</li>
        </ul>
    </div>

    <form action="{{ route('admin.language.process_import') }}" method="POST" enctype="multipart/form-data">
        @csrf
