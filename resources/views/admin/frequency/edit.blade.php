...
<div style="background: white; border-radius: 0.5rem; border: 1px solid #e2e8f0; padding: 2rem; max-width: 600px;">
    <h3 style="font-weight: 700; color: #1e293b; margin-bottom: 1.5rem;">Edit Kala Terbit</h3>

    <form action="{{ route('admin.frequency.update', $frequency->frequency_id) }}" method="POST">
        @csrf
        @method('PUT')
