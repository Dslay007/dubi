...
@section('pageTitle', 'Import Label (CSV)')

@section('content')
<div style="background: white; border-radius: 0.5rem; border: 1px solid #e2e8f0; padding: 2rem; max-width: 800px;">
    <h3 style="font-weight: 700; color: #1e293b; margin-bottom: 1rem;">Impor Data Label dari CSV</h3>
    ...
    <div style="background: #f1f5f9; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem; font-size: 0.9rem; color: #475569;">
        ...
        <ul style="margin-left: 1.5rem; margin-top: 0.5rem;">
            ...
            <li>Kolom 2: <strong>Nama Label</strong> (Wajib)</li>
            <li>Kolom 3: <strong>Deskripsi</strong></li>
            <li>Kolom 4: <strong>Gambar</strong></li>
        </ul>
    </div>

    <form action="{{ route('admin.label.process_import') }}" method="POST" enctype="multipart/form-data">
        @csrf
