...
@section('pageTitle', 'Edit Tipe Koleksi')

@section('content')
<div style="background: white; border-radius: 0.5rem; border: 1px solid #e2e8f0; padding: 2rem; max-width: 600px;">
    <h3 style="font-weight: 700; color: #1e293b; margin-bottom: 1.5rem;">Edit Tipe Koleksi</h3>

    <form action="{{ route('admin.coll_type.update', $collType->coll_type_id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="coll_type_name" value="{{ $collType->coll_type_name }}" required
