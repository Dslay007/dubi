...
<x-master-file-dropdown type="terkendali" current="publisher" />

<x-master-header 
    title="Penerbit (Publishers)" 
    subtitle="Kelola data penerbit buku/koleksi." 
    icon="building-2"
    importRoute="admin.publisher.import"
    exportRoute="admin.publisher.export"
    createRoute="admin.publisher.create"
    createLabel="Tambah Penerbit"
/>
    ...
    <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.875rem;">
            ...
            <tbody>
                ...
                <tr data-href="{{ route('admin.publisher.edit', $publisher->publisher_id) }}" style="border-bottom: 1px solid #e2e8f0;">
