...
<x-master-header 
    title="Tipe Pembawa (Carrier Types)" 
    subtitle="Kelola tipe pembawa materi koleksi perpustakaan." 
    icon="disc-3"
    importRoute="admin.carrier_type.import"
    exportRoute="admin.carrier_type.export"
    createRoute="admin.carrier_type.create"
    createLabel="Tambah Tipe Pembawa"
/>
    ...
    <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.875rem;">
            ...
            <tbody>
                ...
                <tr data-href="{{ route('admin.carrier_type.edit', $item->id) }}" style="border-bottom: 1px solid #e2e8f0;">
