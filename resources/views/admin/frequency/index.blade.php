...
<x-master-header 
    title="Kala Terbit (Frequencies)" 
    subtitle="Kelola interval terbitan berseri seperti majalah atau jurnal." 
    icon="clock-4"
    importRoute="admin.frequency.import"
    exportRoute="admin.frequency.export"
    createRoute="admin.frequency.create"
    createLabel="Tambah Kala Terbit"
/>
