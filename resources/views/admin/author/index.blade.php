...
<x-master-file-dropdown type="terkendali" current="author" />

<x-master-header 
    title="Pengarang (Authors)" 
    subtitle="Kelola data pengarang/penulis untuk dimasukkan pada bibliografi." 
    icon="users"
    importRoute="admin.author.import"
    exportRoute="admin.author.export"
    createRoute="admin.author.create"
    createLabel="Tambah Pengarang"
/>
