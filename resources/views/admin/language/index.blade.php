...
<x-master-header 
    title="Bahasa Dokumen (Languages)" 
    subtitle="Kelola kode dan penamaan bahasa koleksi." 
    icon="globe-2"
    importRoute="admin.language.import"
    exportRoute="admin.language.export"
    createRoute="admin.language.create"
