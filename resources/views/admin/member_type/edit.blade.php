...
@section('pageTitle', 'Edit Tipe Keanggotaan')
...
<div style="display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 1rem; margin-bottom: 2.5rem; background: white; padding: 2rem; border-radius: 1.5rem; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05); border: 1px solid rgba(0,0,0,0.05);">
    <div>
        <h2 style="font-weight: 800; font-size: 1.5rem; color: #0f172a; display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.25rem;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="color: #8b5cf6;"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>
            Edit Tipe Keanggotaan
        </h2>
        <p style="color: #64748b; font-size: 0.95rem; margin: 0;">Perbarui kebijakan peminjaman untuk tipe anggota ini.</p>
    </div>
...
<div style="background: white; border-radius: 1.5rem; overflow: hidden; border: 1px solid rgba(0,0,0,0.05); box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05); max-width: 800px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.member_type.update', $memberType->member_type_id) }}" method="POST" style="padding: 2rem;">
        @csrf
        @method('PUT')
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                <div>
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" name="loan_limit" value="{{ old('loan_limit', $memberType->loan_limit) }}" required min="0" class="input" style="width: 100%; padding: 0.75rem 1rem 0.75rem 2.75rem; border: 2px solid #e2e8f0; border-radius: 0.75rem; outline: none; font-family: inherit; font-size: 0.95rem; transition: 0.2s; background: #f8fafc;" onfocus="this.style.borderColor='#8b5cf6'; this.style.background='white'; this.style.boxShadow='0 0 0 3px rgba(139,92,246,0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.background='#f8fafc'; this.style.boxShadow='none';">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" name="loan_periode" value="{{ old('loan_periode', $memberType->loan_periode) }}" required min="0" class="input" style="width: 100%; padding: 0.75rem 1rem 0.75rem 2.75rem; border: 2px solid #e2e8f0; border-radius: 0.75rem; outline: none; font-family: inherit; font-size: 0.95rem; transition: 0.2s; background: #f8fafc;" onfocus="this.style.borderColor='#8b5cf6'; this.style.background='white'; this.style.boxShadow='0 0 0 3px rgba(139,92,246,0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.background='#f8fafc'; this.style.boxShadow='none';">
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                <div>
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" name="fine_each_day" value="{{ old('fine_each_day', $memberType->fine_each_day) }}" required min="0" class="input" style="width: 100%; padding: 0.75rem 1rem 0.75rem 2.75rem; border: 2px solid #e2e8f0; border-radius: 0.75rem; outline: none; font-family: inherit; font-size: 0.95rem; transition: 0.2s; background: #f8fafc;" onfocus="this.style.borderColor='#8b5cf6'; this.style.background='white'; this.style.boxShadow='0 0 0 3px rgba(139,92,246,0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.background='#f8fafc'; this.style.boxShadow='none';">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" name="grace_period" value="{{ old('grace_period', $memberType->grace_period) }}" required min="0" class="input" style="width: 100%; padding: 0.75rem 1rem 0.75rem 2.75rem; border: 2px solid #e2e8f0; border-radius: 0.75rem; outline: none; font-family: inherit; font-size: 0.95rem; transition: 0.2s; background: #f8fafc;" onfocus="this.style.borderColor='#8b5cf6'; this.style.background='white'; this.style.boxShadow='0 0 0 3px rgba(139,92,246,0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.background='#f8fafc'; this.style.boxShadow='none';">
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                <div>
                    <label class="label" style="display: block; font-weight: 700; font-size: 0.85rem; color: #475569; margin-bottom: 0.5rem; text-transform: uppercase; letter-spacing: 0.05em;">Batas Reservasi (Eksemplar) <span style="color: #ef4444;">*</span></label>
                    <div style="position: relative;">
                        <div style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #94a3b8;">
                        ...
                        <input type="number" name="reservation_limit" value="{{ old('reservation_limit', $memberType->reservation_limit) }}" required min="0" class="input" style="width: 100%; padding: 0.75rem 1rem 0.75rem 2.75rem; border: 2px solid #e2e8f0; border-radius: 0.75rem; outline: none; font-family: inherit; font-size: 0.95rem; transition: 0.2s; background: #f8fafc;" onfocus="this.style.borderColor='#8b5cf6'; this.style.background='white'; this.style.boxShadow='0 0 0 3px rgba(139,92,246,0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.background='#f8fafc'; this.style.boxShadow='none';">
                    </div>
                </div>
            </div>
        </div>
